...
<marquee>These all the products are added by the vendors and not displaying yet on the Shoppee World home page,add them all to the website to display them on the Shoppe World  </marquee>
   ...
   <tr>
     <th scope="row"><%=i %></th>
      ...
      <td><%=rs.getString(8) %></td>
       ...
       <td><a href="allow.jsp?id=<%=rs.getString(1)%>">Allow</a></td>
        <td><a href="Disallow.jsp?id=<%=rs.getString(1)%>">Disallow</a></td>
    </tr>
    <%
    i++;
